...
- **Audio permission**: requests the permission simulator audio capture needs, ahead of time. See [Audio](/guide/audio).
- **Network filter**: installs the filter that network control uses. See [Network Control](/guide/network-control).
